"""The setup for 'coalition' python office suite.

See:
https://github.com/thee-engineer/coalition
"""
...
setup(
    ...
    version=find_version(here, 'src', 'coalition.py'),

    description='A suite of office tools developed in Python.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/thee-engineer/coalition',
